...
{
    public class DistantLookoutCertificate : BaseCertificate<Node>
    {
        public DistantLookoutCertificate(SimulationPoint<Node> u, SimulationPoint<Node> v, double t) : base(u, v, t) { }
