...
{
    public class DistantLookoutYCertificate : BaseCertificate<Node>
    {
        public DistantLookoutYCertificate(SimulationPoint<Node> u, SimulationPoint<Node> v, double t) : base(u, v, t) { }
