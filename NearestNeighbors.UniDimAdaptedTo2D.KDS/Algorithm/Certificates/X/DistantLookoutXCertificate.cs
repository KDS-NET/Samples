...
{
    public class DistantLookoutXCertificate : BaseCertificate<Node>
    {
        public DistantLookoutXCertificate(SimulationPoint<Node> u, SimulationPoint<Node> v, double t) : base(u, v, t) { }
